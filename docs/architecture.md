...
FireRacoon is a monorepo with a Flutter UI, a shared Dart engine, and an optional MCP server.
...
flowchart TB
    ...
    subgraph engine [fireracoon_engine]
        Models
        FireflyApiService
        ProjectionService
        DashboardStats
...
The Flutter app and MCP server share this client through `fireracoon_engine`.
