...
void main() {
  testWidgets('TransactionEditPanel reloads when transaction changes', (
    ...
    final loan = _sampleTransaction(
      id: 'loan-1',
      description: 'Beijersparksgatan loan amortization',
      amount: 3400,
      currencyCode: 'SEK',
      currencySymbol: 'kr',
    );
    final salary = _sampleTransaction(
      id: 'salary-1',
      description: 'Olivier Salary DKK -> DKK',
      amount: 25000,
      currencyCode: 'DKK',
      currencySymbol: 'kr.',
    );
    ...
    expect(find.text('Beijersparksgatan loan amortization'), findsOneWidget);

    await tester.tap(find.text('Switch transaction'));
    await pumpScreen(tester);

    expect(find.text('Olivier Salary DKK -> DKK'), findsOneWidget);
    expect(find.text('Beijersparksgatan loan amortization'), findsNothing);
  });
